...
namespace BridCare.Controllers
{
    ...
    public class ShiftController : Controller
    {
        ...
        public ShiftController(UserManager<User> userManager, InstitutionService institutionService, ShiftService shiftService, InstitutionApplicationService institutionApplicationService)
        {
